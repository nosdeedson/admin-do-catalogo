...
//    private static final String issuerUri;
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                //.authorizeRequests().antMatchers(PUBLIC_MATCHERS).permitAll() can not be used together with authorizeHttpRequests
                //.and()
...
//        return JwtDecoders.fromIssuerLocation("http://localhost:8443/realms/fc3-codeflix");
//    }

    public static class KeycloakJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
